...
public class MainController implements Initializable
{
	...
	public void initialize(URL location, ResourceBundle resources)
	{
		try
		{
			...
			RCDriver.init();
			LOGGER.info("Driver has been initialized successfully!");
		}
		catch (Exception e)
		{
			Dialogs.showExceptionDialog(AlertType.ERROR, "Error", "Failed to initialize driver", e);
			LOGGER.info("Failed to initialize driver: ", e);
		}
	}
	...
	{
		// TODO: Mapping
		LOGGER.warn("onKeyPressed {} : not implemented yet", event.getCode());
	}
	...
	private void handleEvent(HuaweiButtonsType buttonType)
	{
		...
		catch (Exception e)
		{
			...
			LOGGER.warn("Failed to send button: ", e);
		}
	}
}
